      ...
      <div className="min-h-[calc(100vh-theme(spacing.16))] flex flex-col items-center justify-center p-4 bg-retro-bg font-sans text-black">
         ...
         <main className="w-full max-w-sm flex flex-col items-center gap-6" data-purpose="login-form-container">
            ...
            <section className="w-full space-y-3">
               {/* Google Button */}
               <button className="w-full bg-retro-bg text-black border-[3px] border-black shadow-brutal py-2.5 font-bold flex items-center justify-center gap-2 active:shadow-none active:translate-x-[4px] active:translate-y-[4px] transition-all" type="button">
